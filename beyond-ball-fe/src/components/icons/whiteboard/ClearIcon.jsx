...
export const ClearIcon = ({color = "#000000"}) => {
    return (
        <SvgIcon style={{width:"3rem",height:"3rem"}}>
            <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <path d="M18.8332 8.5L18.3732 15.3991C18.1962 18.054 18.1077 19.3815 17.2427 20.1907C16.3777 21 15.0473 21 12.3865 21H11.6132C8.95235 21 7.62195 21 6.75694 20.1907C5.89194 19.3815 5.80344 18.054 5.62644 15.3991L5.1665 8.5" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"/>
