...
import CreateQuiz from "./pages/quizzes/CreateQuiz.jsx"; // ✅ Importat CreateQuiz
            ...
            <ThemeProvider theme={theme}>
                <BrowserRouter>
                    <Routes key={role}>
                        ...
                        />
                        {/* Quizzes Page - doar pentru PLAYER și STAFF */}
                        <Route
                            path="/quizzes"
                            element={
                                ["PLAYER", "STAFF", "ADMIN"].includes(role)
                        ...
                        />
                        {/* Create Quiz Page - doar pentru ADMIN */}
                        <Route
                            path="/create-quiz"
                            element={
                                role === "ADMIN"
                                    ? (() => {
                                        sessionStorage.setItem("lastValidPath", "/create-quiz");
                                        return <CreateQuiz />;
                                    })()
                                    : <AccessDeniedRedirect />
                            }
